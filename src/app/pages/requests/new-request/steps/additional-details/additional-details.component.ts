...
@Component({
    ...
    <div class="mx-auto max-w-md space-y-6">
      <section>
        <h2 class="text-xl font-bold text-[var(--text-primary)]">Photos</h2>
        <p class="mt-1 text-sm text-[var(--text-secondary)]">Add photos to help the professional understand the task better.</p>
        <div class="mt-4 flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[var(--border-color)] bg-[var(--card-background)] px-6 py-12 text-center">
          ...
          <p class="text-base font-semibold text-[var(--text-primary)]">Drag & drop or click to upload</p>
          <p class="mt-1 text-xs text-[var(--text-secondary)]">PNG, JPG, GIF up to 10MB</p>
      ...
      <section>
        <h2 class="text-xl font-bold text-[var(--text-primary)]">Details</h2>
        <p class="mt-1 text-sm text-[var(--text-secondary)]">Provide any extra details or specific instructions.</p>
        <div class="mt-4">
          <textarea 
